...
public class SecurityConfiguaration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/backofficeuser/**").hasAnyAuthority("back_office_user","admin")
		.antMatchers("/investor/**").hasAnyAuthority("investor","admin")
		...
		http.exceptionHandling().accessDeniedPage("/pages/error-page.jsp");
	}
